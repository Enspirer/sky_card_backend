    ...
    <div class="container">
        <div class="row">
            <div class="col-5">
                <div class="row">
                    <ul>
                        <li><a class="navigation-link active" href="#">Home</a></li>
...
<section id="top-slider">
    <div class="container">
        <div class="row">
            <div class="col-1"></div>
            <div class="col-4">
                <h1 data-animscroll="fade-up">Sky Card App</h1>
                ...
                <p data-animscroll="fade-up" data-animscroll-delay="200">
                    Convert paper business card to digital with a single tap
                </p>
                <a class="theam-btn" type="button" href="#" data-animscroll="fade-up" data-animscroll-delay="300">Learn More</a>
            </div>
            <div class="col-7">
                <img data-animscroll="fade-left" src="{{url('light_theme/assets/Group 69.png')}}" style="width: 100%" alt=""/>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-6" data-animscroll="fade-right">
                <h1 data-animscroll="fade-up">Sky Daily</h1>
                <h5 data-animscroll="fade-up" data-animscroll-delay="100">
...
<section id="sky-vip">
    ...
    <div class="container vip-container">
        <div class="row">
            <div class="col-6">
                <div class="details">
                    <h1 data-animscroll="fade-up">Sky <span>VIP</span></h1>
                    <h5 data-animscroll="fade-up">
                        Become a member & enjoy exclusive offers from
                    </h5>
...
<section id="contract-organizer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 pl-5" data-animscroll="fade-left">
                <h1 data-animscroll="fade-up">Contact Organizer</h1>
                <h5 data-animscroll="fade-up" data-animscroll-delay="100">
                    Forget about card holders!
                </h5>
                <p data-animscroll="fade-up" data-animscroll-delay="200">
