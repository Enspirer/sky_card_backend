    ...
    <div class="text-center card-box">
        <div class="member-card pt-2 pb-2">
            <div class="thumb-lg member-thumb mx-auto">
                <img src="{{url('files/preview_files/',$df_company_logo)}}" class="rounded-circle img-thumbnail" style="object-fit: contain;height: 80px;width: 80px;" alt="profile-image"></div>
            <div class="">
