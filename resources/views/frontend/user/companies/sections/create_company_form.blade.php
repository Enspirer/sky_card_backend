...
<div class="form-row">
    ...
    <div class="col-md-6">
        <div class="position-relative form-group">
            <label for="exampleState" class="">Website</label>
            <input name="website" id="exampleState" type="text" class="form-control">
        </div>
    </div>
    <div class="col-md-12">
        <div class="position-relative form-group">
...
<button type="submit" class="btn btn-primary">Create your Company</button>