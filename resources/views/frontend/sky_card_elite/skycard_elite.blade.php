...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <img
                            ...
                            class="right-img"
                            src="{{url('light_theme/assets/Group 544.png')}}"
                            alt=""
                    />
                </div>
            </div>
    ...
    <section id="demo">
        ...
        <div class="container p-5">
            <h4 data-animscroll="fade-up" data-animscroll-delay="100">Request for a demo or </h4>
            <h3 data-animscroll="fade-up" data-animscroll-delay="100">Order Sky Card Elite Today</h3>
            <div class="row ml-0 mr-0 mt-5 pl-5 pr-5 d-flex justify-content-center">
                <a data-animscroll="fade-right"0" type="button" class="theam-btn-orange with pt" href="#">Inquire Now</a>
                <a data-animscroll="fade-left" type="button" class="theam-btn-light ml-4 pt" href="#">Call Us +94 778 669 990</a>
            </div>
        </div>
