            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        <label>Status</label>
                        <input type="text" value="{{$order_details->status}}" class="form-control" readonly>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$order_details->email_type}}" class="form-control" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="">
                                <div style="background-image: url('{{url('files/email_promo',$order_details->attached_file)}}');height: 270px;background-repeat: no-repeat;background-size: cover;"></div>
                            </div>
                        </div>
                    </div>
